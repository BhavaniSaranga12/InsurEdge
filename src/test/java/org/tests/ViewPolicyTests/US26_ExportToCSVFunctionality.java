...
public class US26_ExportToCSVFunctionality extends ViewPolicyBaseTest {

    @Test(priority = 1)
    public void testExportToCSVDownload() throws InterruptedException{
        ...
        WebElement exportBtn = driver.findElement(By.id("ContentPlaceHolder_Admin_btnExportCSV"));
        ...
        Assert.assertTrue(latestFile.getName().endsWith(".csv"), "Downloaded file is not in .csv format");
